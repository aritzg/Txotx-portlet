...
/**
 * The base implementation of the a p k version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.txotx.service.impl.APKVersionLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 ...
 * @generated
 */
public abstract class APKVersionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements APKVersionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.txotx.service.APKVersionLocalServiceUtil} to access the a p k version local service.
	 */
	...
	public APKVersion addAPKVersion(APKVersion apkVersion)
		throws SystemException {
		apkVersion.setNew(true);

		return apkVersionPersistence.update(apkVersion, false);
	}
	 ...
	 */
	public APKVersion createAPKVersion(long apkVersionId) {
		return apkVersionPersistence.create(apkVersionId);
	}
	...
	public APKVersion deleteAPKVersion(long apkVersionId)
		throws PortalException, SystemException {
		return apkVersionPersistence.remove(apkVersionId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public APKVersion deleteAPKVersion(APKVersion apkVersion)
		throws SystemException {
		return apkVersionPersistence.remove(apkVersion);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(APKVersion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return apkVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return apkVersionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return apkVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public APKVersion fetchAPKVersion(long apkVersionId)
		throws SystemException {
		return apkVersionPersistence.fetchByPrimaryKey(apkVersionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public APKVersion getAPKVersion(long apkVersionId)
		throws PortalException, SystemException {
		return apkVersionPersistence.findByPrimaryKey(apkVersionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return apkVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<APKVersion> getAPKVersions(int start, int end)
		throws SystemException {
		return apkVersionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAPKVersionsCount() throws SystemException {
		return apkVersionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public APKVersion updateAPKVersion(APKVersion apkVersion)
		throws SystemException {
		return updateAPKVersion(apkVersion, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public APKVersion updateAPKVersion(APKVersion apkVersion, boolean merge)
		throws SystemException {
		apkVersion.setNew(false);

		return apkVersionPersistence.update(apkVersion, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.txotx.model.APKVersion",
			apkVersionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = apkVersionPersistence.getDataSource();
	...
	private APKVersionLocalServiceClpInvoker _clpInvoker = new APKVersionLocalServiceClpInvoker();
}