...
/**
 * The base implementation of the google device local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.txotx.service.impl.GoogleDeviceLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 ...
 * @generated
 */
public abstract class GoogleDeviceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GoogleDeviceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.txotx.service.GoogleDeviceLocalServiceUtil} to access the google device local service.
	 */
	...
	public GoogleDevice addGoogleDevice(GoogleDevice googleDevice)
		throws SystemException {
		googleDevice.setNew(true);

		return googleDevicePersistence.update(googleDevice, false);
	}
	 ...
	 */
	public GoogleDevice createGoogleDevice(long googleDeviceId) {
		return googleDevicePersistence.create(googleDeviceId);
	}
	...
	public GoogleDevice deleteGoogleDevice(long googleDeviceId)
		throws PortalException, SystemException {
		return googleDevicePersistence.remove(googleDeviceId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GoogleDevice deleteGoogleDevice(GoogleDevice googleDevice)
		throws SystemException {
		return googleDevicePersistence.remove(googleDevice);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(GoogleDevice.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return googleDevicePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return googleDevicePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public GoogleDevice fetchGoogleDevice(long googleDeviceId)
		throws SystemException {
		return googleDevicePersistence.fetchByPrimaryKey(googleDeviceId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public GoogleDevice getGoogleDevice(long googleDeviceId)
		throws PortalException, SystemException {
		return googleDevicePersistence.findByPrimaryKey(googleDeviceId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return googleDevicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<GoogleDevice> getGoogleDevices(int start, int end)
		throws SystemException {
		return googleDevicePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getGoogleDevicesCount() throws SystemException {
		return googleDevicePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GoogleDevice updateGoogleDevice(GoogleDevice googleDevice)
		throws SystemException {
		return updateGoogleDevice(googleDevice, true);
	}
	...
	public GoogleDevice updateGoogleDevice(GoogleDevice googleDevice,
		...
		return googleDevicePersistence.update(googleDevice, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.txotx.model.GoogleDevice",
			googleDeviceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = googleDevicePersistence.getDataSource();
	...
	private GoogleDeviceLocalServiceClpInvoker _clpInvoker = new GoogleDeviceLocalServiceClpInvoker();
}