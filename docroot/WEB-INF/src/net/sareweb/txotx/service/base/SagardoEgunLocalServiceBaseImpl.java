...
/**
 * The base implementation of the sagardo egun local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.txotx.service.impl.SagardoEgunLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 ...
 * @generated
 */
public abstract class SagardoEgunLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SagardoEgunLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.txotx.service.SagardoEgunLocalServiceUtil} to access the sagardo egun local service.
	 */
	...
	public SagardoEgun addSagardoEgun(SagardoEgun sagardoEgun)
		throws SystemException {
		sagardoEgun.setNew(true);

		return sagardoEgunPersistence.update(sagardoEgun, false);
	}
	 ...
	 */
	public SagardoEgun createSagardoEgun(long sagardoEgunId) {
		return sagardoEgunPersistence.create(sagardoEgunId);
	}
	...
	public SagardoEgun deleteSagardoEgun(long sagardoEgunId)
		throws PortalException, SystemException {
		return sagardoEgunPersistence.remove(sagardoEgunId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SagardoEgun deleteSagardoEgun(SagardoEgun sagardoEgun)
		throws SystemException {
		return sagardoEgunPersistence.remove(sagardoEgun);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SagardoEgun.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return sagardoEgunPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return sagardoEgunPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sagardoEgunPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SagardoEgun fetchSagardoEgun(long sagardoEgunId)
		throws SystemException {
	...
	public SagardoEgun getSagardoEgun(long sagardoEgunId)
		throws PortalException, SystemException {
		return sagardoEgunPersistence.findByPrimaryKey(sagardoEgunId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sagardoEgunPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SagardoEgun> getSagardoEguns(int start, int end)
		throws SystemException {
		return sagardoEgunPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSagardoEgunsCount() throws SystemException {
		return sagardoEgunPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SagardoEgun updateSagardoEgun(SagardoEgun sagardoEgun)
		throws SystemException {
		return updateSagardoEgun(sagardoEgun, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SagardoEgun updateSagardoEgun(SagardoEgun sagardoEgun, boolean merge)
		throws SystemException {
		sagardoEgun.setNew(false);

		return sagardoEgunPersistence.update(sagardoEgun, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.txotx.model.SagardoEgun",
			sagardoEgunLocalService);
	}
	...
	private SagardoEgunLocalServiceClpInvoker _clpInvoker = new SagardoEgunLocalServiceClpInvoker();
}