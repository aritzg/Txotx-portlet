 ...
 * @author A.Galdos
 */
public class GoogleDeviceServiceClp implements GoogleDeviceService {
	public GoogleDeviceServiceClp(InvokableService invokableService) {
	...
	public java.util.List<net.sareweb.txotx.model.GoogleDevice> getGoogleDevicesByUserId(
		...
		return (java.util.List<net.sareweb.txotx.model.GoogleDevice>)ClpSerializer.translateOutput(returnObj);
	}
