 ...
 * @author A.Galdos
 */
public class OharraLocalServiceClp implements OharraLocalService {
	public OharraLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public net.sareweb.txotx.model.Oharra addOharra(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(oharra) });
		}
		catch (Throwable t) {
		...
		return (net.sareweb.txotx.model.Oharra)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.Oharra createOharra(long oharraId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { oharraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Oharra deleteOharra(long oharraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { oharraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Oharra fetchOharra(long oharraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { oharraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Oharra getOharra(long oharraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { oharraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.Oharra> getOharras(
		...
		return (java.util.List<net.sareweb.txotx.model.Oharra>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.Oharra updateOharra(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(oharra), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
