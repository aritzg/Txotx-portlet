 ...
 * @author A.Galdos
 */
public class GertaeraLocalServiceClp implements GertaeraLocalService {
	public GertaeraLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public net.sareweb.txotx.model.Gertaera addGertaera(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(gertaera) });
		}
		catch (Throwable t) {
	...
	public net.sareweb.txotx.model.Gertaera createGertaera(long gertaeraId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { gertaeraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Gertaera deleteGertaera(long gertaeraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { gertaeraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Gertaera fetchGertaera(long gertaeraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { gertaeraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Gertaera getGertaera(long gertaeraId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { gertaeraId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Gertaera updateGertaera(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(gertaera), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
