 ...
 * @author A.Galdos
 */
public class APKVersionLocalServiceClp implements APKVersionLocalService {
	public APKVersionLocalServiceClp(
	...
	public net.sareweb.txotx.model.APKVersion addAPKVersion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(apkVersion) });
		}
		catch (Throwable t) {
		...
		return (net.sareweb.txotx.model.APKVersion)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.APKVersion createAPKVersion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { apkVersionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.APKVersion deleteAPKVersion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { apkVersionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.APKVersion fetchAPKVersion(long apkVersionId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { apkVersionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.APKVersion getAPKVersion(long apkVersionId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { apkVersionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.APKVersion> getAPKVersions(
		...
		return (java.util.List<net.sareweb.txotx.model.APKVersion>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.APKVersion updateAPKVersion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(apkVersion), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
