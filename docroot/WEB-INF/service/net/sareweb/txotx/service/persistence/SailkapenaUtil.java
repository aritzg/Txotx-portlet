...
/**
 * The persistence utility for the sailkapena service. This utility wraps {@link SailkapenaPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SailkapenaUtil {
	 ...
	 */
	public static void clearCache(Sailkapena sailkapena) {
		getPersistence().clearCache(sailkapena);
	}
	 ...
	 */
	public static List<Sailkapena> findWithDynamicQuery(
	 ...
	 */
	public static Sailkapena update(Sailkapena sailkapena, boolean merge)
		throws SystemException {
		return getPersistence().update(sailkapena, merge);
	}
	...
	public static Sailkapena update(Sailkapena sailkapena, boolean merge,
		...
		return getPersistence().update(sailkapena, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sailkapena);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sailkapenas);
	}
	...
	*/
	public static net.sareweb.txotx.model.Sailkapena create(long sailkapenaId) {
		return getPersistence().create(sailkapenaId);
	}
	...
	*/
	public static net.sareweb.txotx.model.Sailkapena remove(long sailkapenaId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.sareweb.txotx.NoSuchSailkapenaException {
		return getPersistence().remove(sailkapenaId);
	}

	public static net.sareweb.txotx.model.Sailkapena updateImpl(
		net.sareweb.txotx.model.Sailkapena sailkapena, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(sailkapena, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena findByPrimaryKey(
		long sailkapenaId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.sareweb.txotx.NoSuchSailkapenaException {
		return getPersistence().findByPrimaryKey(sailkapenaId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena fetchByPrimaryKey(
		long sailkapenaId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(sailkapenaId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena findByUserId(long userId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.sareweb.txotx.NoSuchSailkapenaException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena fetchByUserId(long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena fetchByUserId(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<net.sareweb.txotx.model.Sailkapena> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.txotx.model.Sailkapena removeByUserId(long userId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.sareweb.txotx.NoSuchSailkapenaException {
	...
	*/
	...
	public static SailkapenaPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SailkapenaPersistence)PortletBeanLocatorUtil.locate(net.sareweb.txotx.service.ClpSerializer.getServletContextName(),
					SailkapenaPersistence.class.getName());

			ReferenceRegistry.registerReference(SailkapenaUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(SailkapenaPersistence persistence) {
	}

	private static SailkapenaPersistence _persistence;
}