 ...
 * @author A.Galdos
 */
public class JarraipenServiceClp implements JarraipenService {
	public JarraipenServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "gehituJarraipenaByEmail";

		_methodParameterTypes3 = new String[] {
				"java.lang.String", "long", "java.lang.String"
			};

		_methodName4 = "gehituJarraipena";

		_methodParameterTypes4 = new String[] { "long", "long", "java.lang.String" };

		_methodName5 = "getJarraipenakByEmail";

		_methodParameterTypes5 = new String[] { "java.lang.String" };

		_methodName6 = "getJarraipenak";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "getErabiltzailearenJarraitzaileak";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "getSagardotegiarenJarraitzaileak";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "getSagardoEgunarenJarraitzaileak";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "deleteJarraipena";
	...
	public net.sareweb.txotx.model.Jarraipen gehituJarraipenaByEmail(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					...
					ClpSerializer.translateInput(jarraipenMota)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.Jarraipen> getJarraipenak(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { jarraitzaileUserId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.Jarraipen> getErabiltzailearenJarraitzaileak(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName7,
					_methodParameterTypes7, new Object[] { jarraituaUserId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.Jarraipen> getSagardotegiarenJarraitzaileak(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { sagardotegiId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
