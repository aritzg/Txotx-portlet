 ...
 * @author A.Galdos
 */
public class SailkapenaLocalServiceClp implements SailkapenaLocalService {
	public SailkapenaLocalServiceClp(
	...
	public net.sareweb.txotx.model.Sailkapena addSailkapena(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(sailkapena) });
		}
		catch (Throwable t) {
		...
		return (net.sareweb.txotx.model.Sailkapena)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.Sailkapena createSailkapena(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { sailkapenaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Sailkapena deleteSailkapena(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { sailkapenaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Sailkapena fetchSailkapena(long sailkapenaId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { sailkapenaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public net.sareweb.txotx.model.Sailkapena getSailkapena(long sailkapenaId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { sailkapenaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<net.sareweb.txotx.model.Sailkapena> getSailkapenas(
		...
		return (java.util.List<net.sareweb.txotx.model.Sailkapena>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.txotx.model.Sailkapena updateSailkapena(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(sailkapena), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void incGertaera(long userId, java.lang.String geraeraMota) {
		try {
			_invokableLocalService.invokeMethod(_methodName19,
				...
				new Object[] { userId, ClpSerializer.translateInput(geraeraMota) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
