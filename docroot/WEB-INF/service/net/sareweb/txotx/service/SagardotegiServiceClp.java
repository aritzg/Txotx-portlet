 ...
 * @author A.Galdos
 */
public class SagardotegiServiceClp implements SagardotegiService {
	public SagardotegiServiceClp(InvokableService invokableService) {
	...
	public net.sareweb.txotx.model.Sagardotegi getSagardotegia(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { sagardotegiId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (net.sareweb.txotx.model.Sagardotegi)ClpSerializer.translateOutput(returnObj);
	}
